              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-body mt-5 ms-3 me-3 ">
                    <form class="row g-3 needs-validation" novalidate action="register-patient" method="post">
                      <div class="col-md-6">
                      ...
                      <div class="col-12 mb-3">
                        ...
                        <div class="input-group">
                          ...
                          <input type="date" name="birthday" data-name="dtp1-text" class="form-control" placeholder="1400/01/01">
                        </div>

                      </div>
                      <div class="col-12 mb-3">
                       
                        <label for="inputPassword" class="col-form-label ">Disease Name</label>

                        <div class="input-group">
                          
                          <input type="text" name="disease" data-name="dtp1-text" class="form-control">
                        </div>
